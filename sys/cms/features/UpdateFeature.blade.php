...
<div class="modal modal-blur fade" id="UpdateFeature{{ $data->id }}" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <form action="{{ route('UpdateFeature') }}" method="POST">
              ...
              <div class="row g-6">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="Desc" class="form-control" id="" cols="30" rows="5">{{ $data->Desc }}</textarea>
                </div>
                <div class="row mt-2">
                    <p>Icons example</p>
